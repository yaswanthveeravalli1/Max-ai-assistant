...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.jarvis.vqzrtp"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  androidResources {
    // Prevent AAPT from compressing Vosk model files — compression corrupts binary model data
    noCompress += listOf("mdl", "fst", "mat", "dubm", "ie", "conf", "stats", "int")
  }
  buildFeatures {
    compose = true
    buildConfig = true
...
tasks.register("buildAndCopyApk") {
